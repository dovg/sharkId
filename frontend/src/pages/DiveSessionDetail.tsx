...
export default function DiveSessionDetail() {
  ...
  if (loading)
    return (
      <PageLayout title="Dive Session" breadcrumb={[{ label: 'Dive Sessions', to: '/dive-sessions' }]} breadcrumbCurrent="Session Detail">
        <LoadingState />
      </PageLayout>
    )
  ...
  if (!session)
    return (
      <PageLayout title="Dive Session" breadcrumb={[{ label: 'Dive Sessions', to: '/dive-sessions' }]} breadcrumbCurrent="Session Detail">
        <AlertError message={error || 'Session not found'} />
      </PageLayout>
    )
  ...
  return (
    <PageLayout
      title="Dive Session"
      breadcrumb={[{ label: 'Dive Sessions', to: '/dive-sessions' }]}
      breadcrumbCurrent="Session Detail"
      actions={
        <>
          <button
